...
-(id)initWithFrame:(CGRect)frame;
{
    ...
    if (self) {
        ...
        MYTABLEVIEW_(_leftTableView, 0, 10, 0, 0, UITableViewStylePlain, [UIColor yellowColor], kSepetorColor, self);
        MYTABLEVIEW_(_rightTableView, 0, 10, 0, 0, UITableViewStylePlain, kFocusTextColor, kSepetorColor, self);
...
-(void)animationDown:(int)tapIndex
{
    ...
    switch (tapIndex) {
        case 0:
            _noneView.frame=CGRectMake(0, 10, WIDTH, 0);
            _leftTableView.frame=CGRectMake(0, 10, WIDTH, 0);
            _rightTableView.frame=CGRectMake(WIDTH*leftScale, 10, WIDTH*(1-leftScale), 0);
            
            break;
        case 1:
            _noneView.frame=CGRectMake(0, 10, WIDTH, 0);
            _leftTableView.frame=CGRectMake(0, 10, WIDTH, 0);
            _rightTableView.frame=CGRectMake(0, 10, WIDTH, 0);
    ...
    [UIView animateWithDuration:0.3 animations:^{
        ...
        switch (tapIndex) {
            case 0:
                _noneView.hidden=NO;
                _noneView.frame=CGRectMake(0, 15, WIDTH, 270);
                break;
            case 1:
                _noneView.hidden=YES;
                _rightTableView.frame=CGRectMake(0, 15, WIDTH, rowHeight*count<rowHeight*rowNum?rowHeight*count:rowHeight*rowNum);
                
                break;
            case 2:
                _noneView.hidden=YES;
                _leftTableView.frame=CGRectMake(0, 15, WIDTH*leftScale, rowHeight*count<rowHeight*rowNum?rowHeight*count:rowHeight*rowNum);
                _rightTableView.frame=CGRectMake(WIDTH*leftScale, 15, WIDTH*(1-leftScale), rowHeight*count<rowHeight*rowNum?rowHeight*count:rowHeight*rowNum);
