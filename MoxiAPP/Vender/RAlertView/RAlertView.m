...
-(void)viewInitUI{
    ...
    [self.contentView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.headerTitleLabel.mas_bottom).offset(15);
...
//        [_confirmButton setTitle:@"Ok" forState:UIControlStateNormal];
        [_confirmButton setBackgroundImage:[UIImage imageNamed:@"close_icon_alert"] forState:UIControlStateNormal];
...
-(UILabel*)headerTitleLabel {
    if (_headerTitleLabel == nil) {
        ...
        [_headerTitleLabel setFont:[UIFont systemFontOfSize:20]];
        [_headerTitleLabel setTextAlignment:NSTextAlignmentLeft];
        [_headerTitleLabel setTextColor:kFocusTextColor];
    }
...
-(UILabel*)contentTextLabel {
    if (_contentTextLabel == nil) {
        ...
        [_contentTextLabel setFont:[UIFont systemFontOfSize:17]];
        [_contentTextLabel setTextAlignment:NSTextAlignmentLeft];
        [_contentTextLabel setTextColor:kFocusTextColor];
