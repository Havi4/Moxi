...
- (NSArray *)viewControllers {
    ...
    UIViewController *jobNavigationController = [[BaseNaviViewController alloc]
                                                  initWithRootViewController:home];


    CheckOrderViewController *companyViewController = [[CheckOrderViewController alloc]init];
    UIViewController *companyNavigationController = [[BaseNaviViewController alloc]
...
//                                                 CYLTabBarItemTitle : @"主页",
                                                 CYLTabBarItemImage : @"home_normal_icon",
                                                 CYLTabBarItemSelectedImage : @"home_highlight_icon",
                                                 };
    NSDictionary *secondTabBarItemsAttributes = @{
//                                                  CYLTabBarItemTitle : nil,
                                                  CYLTabBarItemImage : @"account_normal_icon",
                                                  CYLTabBarItemSelectedImage : @"account_highlight_icon",
                                                  };
...
#warning CUSTOMIZE YOUR TABBAR APPEARANCE
    ...
    [[UITabBar appearance] setBackgroundColor:kNaviBarBackColor];
